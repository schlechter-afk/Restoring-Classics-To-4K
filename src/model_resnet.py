...
if __name__ == "__main__":
    ...
    WANDB_RUN_NAME     = f"resnet_backbone_{LR}_{WEIGHT_DECAY}_{VAL_FREQUENCY}"
            ...
            if batch_count % VAL_FREQUENCY == 0:
                ...
                with torch.no_grad():
                    for val_batch in val_dataloader:
                        pbar.set_postfix_str(f"Colorizer Loss: {epoch_colorizer_loss / batch_count:.4f}, Upscaler Loss: {epoch_upscaler_loss / batch_count:.4f}, Avg Loss: {epoch_train_loss / batch_count:.4f}, Val Batch: {val_batch_count + 1}")
                        ...
                        val_original_rgb = F.interpolate(
                            val_original_rgb,
                            size=(270, 512),
                            mode="bilinear",
                            align_corners=False
